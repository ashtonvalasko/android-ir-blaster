...
| RCC2026 | 11 hex > 42 bits (left-aligned) | 38,222 | Header 8800/4400; bit mark=550 + space 550 (0) or 1650 (1); final mark 550 + 23100; then tail [8800, 4400, 550, 90750] | Strict 11 hex; two trailing padding bits ignored |
...
| Sharp | 4 hex (left-aligned wire frame) | 38,000 | First 13 bits contain the LSB-first address and command; send normal, inverted-command, then normal frames; timing uses 280/860 for 0 and 280/1720 for 1 with protocol tail blocks between frames | Strict 4 hex; trailing control/padding bits are regenerated |
